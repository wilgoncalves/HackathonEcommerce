        ...
        <div className="flex md:justify-between items-center flex-col gap-6 md:flex-row mt-10 md:items-start">
            <section>
                <div className="flex flex-col md:items-start items-center">
                    <h1 className="lg:text-xl font-bold font-outfit mb-6">Contate-nos</h1>
            ...
            <section>
                <div className="flex flex-col md:items-start items-center">
                    ...
                    <p className="lg:text-xl font-normal font-outfit mb-4">Perguntas frequentes</p>
                    <p className="lg:text-xl font-normal font-outfit mb-4">Métodos de pagamento</p>
                    <a href="https://wa.me/11999999999"><p className="lg:text-xl font-normal font-outfit">Contate-nos</p></a>
                </div>
            ...
            <section>
                <div className="flex flex-col md:items-start items-center">
                    ...
                    <a href="#home"><p className="lg:text-xl font-normal font-outfit mb-4">Home</p></a>
                    <a href="#produtos"><p className="lg:text-xl font-normal font-outfit mb-4">Produtos</p></a>
                    <a href="#destaques"><p className="lg:text-xl font-normal font-outfit">Destaques</p></a>
                </div>
