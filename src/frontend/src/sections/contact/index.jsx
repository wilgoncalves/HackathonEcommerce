...
const Contact = () => {
    return (
        ...
        style={{ backgroundImage: `url(${BackgroundImage})` }}>
            <h1 className="font-caveat white-normal md:text-[64px] text-[40px] mb-4">Faça seu pedido no Whatsapp</h1>
            <p className="md:text-[22px] text-[18px] mb-6">Clique no botão abaixo e fale com um atendente</p>
